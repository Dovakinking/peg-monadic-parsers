...
-- | Generate a Haskell module in which every PEG rule is represented as a
-- definition of type Parser ().  The generated module depends only on this
-- package's PEG.Runtime module.
